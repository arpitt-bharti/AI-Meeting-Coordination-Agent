...
def list_upcoming_events():
    try:
        ...
        print(f'service returned from get_Calender_Service - {service}')
        print(f'service event {service.events().list}')
        ...
        # Loop through and display the structured data
        # for event in events:
        #     start = event['start'].get('dateTime', event['start'].get('date')) 
        #     print(f"⏰ {start} - 🗓️ {event['summary']}")
